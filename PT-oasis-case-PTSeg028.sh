...
required_time="00:04:59"          # amount of time cluster will need to run the case (max 24 hours)
...
save_frequency=100                # write solution every N steps (default: 5)
checkpoint=100                    # write restart every N steps
